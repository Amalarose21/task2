...
if (isset($_GET['search']) && $_GET['search'] != "") {
    ...
    $stmt = mysqli_prepare($conn, "SELECT * FROM posts WHERE title LIKE ? OR content LIKE ? ORDER BY id DESC LIMIT ?, ?");
    ...
    $stmt = mysqli_prepare($conn, "SELECT * FROM posts ORDER BY id DESC LIMIT ?, ?");
